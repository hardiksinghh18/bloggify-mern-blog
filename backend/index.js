...
app.post('/register', async (req, res) => {
    ...
    try {
        ...
        res.cookie('accessToken', token, { maxAge: 90 * 24 * 60 * 60 * 1000 ,  secure: false,sameSite: 'None'})
        res.cookie('refreshToken', refreshToken, { maxAge: 90 * 24 * 60 * 60 * 1000 ,  secure: false, sameSite: 'None'})
