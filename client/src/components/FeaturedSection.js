    ...
    return (
        <section className="w-full max-w-6xl mx-auto mt-10 sm:mt-16 px-5 sm:px-8 md:px-12">
            ...
            <div className="flex flex-col lg:flex-row gap-8">
                {/* Hero Card */}
                {heroPost && (
                    <a href={`/blogs/${heroPost?._id}/${heroPost?.title}`} className="group relative flex-1 min-h-[320px] sm:min-h-[400px] rounded-3xl overflow-hidden block">
                        <img
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 z-10">
                            <div className="flex items-center gap-3 mb-3">
                                ...
                                <span className="text-xs text-white/70">{heroReadTime} min</span>
                            </div>
                ...
                <div className="lg:w-[380px] xl:w-[420px] flex flex-col gap-1">
                    ...
                    {sidePosts?.map((blog, index) => {
                        ...
                        return (
                            <a key={blog?._id || index} href={`/blogs/${blog?._id}/${blog?.title}`} className="group flex gap-4 items-start p-4 rounded-2xl hover:bg-gray-100 dark:hover:bg-white/5 transition-colors duration-200">
