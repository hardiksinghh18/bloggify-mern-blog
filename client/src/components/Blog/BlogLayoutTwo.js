    ...
    return (
        <Link to={`/blogs/${blog?.slug}`} className="group flex gap-5 items-start p-4 rounded-2xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors duration-200">
            ...
            <div className="flex flex-col justify-between flex-1 min-h-[90px] sm:min-h-[100px]">
                <h2 className="font-bold text-sm sm:text-[17px] leading-snug line-clamp-2 group-hover:text-[#b8004e] dark:group-hover:text-[#d81b60] transition-colors duration-200">
                    {blog?.title}
                </h2>
