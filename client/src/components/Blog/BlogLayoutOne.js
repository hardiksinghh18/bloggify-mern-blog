        ...
        <div className="group relative inline-block overflow-hidden rounded-xl">
            ...
            <a href={`blogs/${blog?._id}/${blog?.title}`} className="mt-6">
                <div className='  relative w-32 h-24 sm:w-96 sm:h-64   '>
                    <img className="w-full h-full object-center object-cover rounded-xl  group-hover:scale-105 transition-all ease duration-300" src={`http://localhost:4000/${blog?.coverImage}`} alt="" />
